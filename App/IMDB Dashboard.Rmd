...
TV series and ratings data for 1000+ shows in the IMDb database. Select a series above and see the ratings for each episode.
...
```{r}
 ...
 renderPlotly({
     ggplotly(ggplot(heatmap_plot(), tooltip = "episode", aes(season_ep, season, fill = user_rating)) +
     geom_tile() +
